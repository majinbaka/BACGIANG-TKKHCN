...
class CreateBieutonghop4Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bieutonghop4', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('field_34')->nullable();
            $table->string('field_35')->nullable();
            $table->string('field_36')->nullable();
            $table->string('field_37')->nullable();
            $table->string('field_38')->nullable();
            $table->timestamps();
        });
    }

...
@section('content')  
                ...
                @endif
                @if(in_array(10, $cans))
                <input type="submit" name="10" value="Biểu 10" id="ctl00_ContentPlaceHolder1_ctl00_Tab10" title="Biểu 10/TKTH-KHCN-ĐP: Thanh tra khoa học và công nghệ" class="Clicked" style="border-style:None;" />
                @endif
                @if(in_array(11, $cans))
...
<style type="text/css">
    ...
    <form role="form" method="POST" action="{{ url('/bieutonghop10/year') }}">
                {{ csrf_field() }}
            ...
            <table style="width: 100%; border-spacing: 0px; border: 0px;">
                <tr>
                    <td style="width: 200px">
                        <b> Biểu 10/TKTH-KHCN-ĐP</b>
                        <br />
                        26/2015/TT-BKHCN</td>
                    <td align="left">
                       <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; THANH TRA KHOA HỌC VÀ CÔNG NGHỆ</b>
                        <br />
...
@endforeach
    ...
    <form role="form" method="POST" action="{{ url('/generate/tonghop/bieu/10/'.$bieu->id) }}">
                {{ csrf_field() }}
                        <table>
            <tr>
	...
	<tr>
		<td class="Table_Header" rowspan="2" style="width:200px;"></td><td class="Table_Header" rowspan="2" style="width:50px;">Mã số</td><td class="Table_Header" rowspan="2" style="width:50px;">Đơn vị tính</td><td class="Table_Header" rowspan="2" style="width:50px;">Tổng số</td><td class="Table_Header" colspan="6" rowspan="1">LĨNH VỰC THANH TRA CHUYÊN NGÀNH</td><td class="Table_Header" colspan="1" rowspan="2">Thanh tra hành chính</td><td class="Table_Header" colspan="1" rowspan="2">Khác</td>
	</tr><tr>
		<td class="Table_Header" rowspan="1">Sở hữu công nghiệp</td><td class="Table_Header" rowspan="1">Tiêu chuẩn đo lường chất lượng</td><td class="Table_Header" rowspan="1">An toàn bức xạ, hạt nhân</td><td class="Table_Header" rowspan="1">Nhiệm vụ KH&CH</td><td class="Table_Header" rowspan="1">Tổ chức KH&CN</td><td class="Table_Header" rowspan="1">Chuyển giao công nghệ</td>
	</tr><tr>
		<td class="KH_ThuTuCot_Mau01" colspan="1">A</td><td class="KH_ThuTuCot_Mau01" colspan="1">B</td><td class="KH_ThuTuCot_Mau01" colspan="1">C</td><td class="KH_ThuTuCot_Mau01" colspan="1">1</td><td class="KH_ThuTuCot_Mau01" colspan="1">2</td><td class="KH_ThuTuCot_Mau01" colspan="1">3</td><td class="KH_ThuTuCot_Mau01" colspan="1">4</td><td class="KH_ThuTuCot_Mau01" colspan="1">5</td><td class="KH_ThuTuCot_Mau01" colspan="1">6</td><td class="KH_ThuTuCot_Mau01" colspan="1">7</td><td class="KH_ThuTuCot_Mau01" colspan="1">8</td><td class="KH_ThuTuCot_Mau01" colspan="1">9</td>
	</tr>@php

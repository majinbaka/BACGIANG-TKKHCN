...
<form role="form" method="POST" action="{{ url('/bieutonghop11/'.$bieu->id.'/year') }}">
                {{ csrf_field() }}
      ...
      {{$bieu->field_9}}</td>
                ...
                width: 100%">
                            ...
                            <div style="height: 25px; text-align:center; width: 100%">
                                <a href="/generate/tonghop/bieu/11/{{$bieu->id}}" name="ctl00$ContentPlaceHolder1$ctl00$ctl00$btnIn" value="Xuất in" id="ctl00_ContentPlaceHolder1_ctl00_ctl00_btnIn" class="button">Xuất in</a>
                            </div>
                            </td>
                            </tr>
                            </table>

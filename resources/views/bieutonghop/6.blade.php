...
@section('content')      
                ...
                <input type="submit" name="6" value="Biểu 06" id="ctl00_ContentPlaceHolder1_ctl00_Tab6" title="Biểu 06/TKTH-KHCN-ĐP: Giải thưởng khoa học và công nghệ" class="Clicked" style="border-style:None;" />
     ...
     <form role="form" method="POST" action="{{ url('/bieutonghop6/'.$bieu->id.'/year') }}">
                {{ csrf_field() }}
            ...
            <table style="width: 100%; border-spacing: 0px; border: 0px;">
                <tr>
                     <td style="width: 200px">
                        <b> Biểu 06/TKTH-KHCN-ĐP</b>
                         <br />
                         26/2015/TT-BKHCN</td>
                    <td align="left">
                       <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; GIẢI THƯỞNG KHOA HỌC VÀ CÔNG NGHỆ</b>
                        <br />
...
<form role="form" method="POST" action="{{ url('/generate/tonghop/bieu/6/'.$bieu->id) }}">
                {{ csrf_field() }}            <table>
            <tr>
...
@endphp
<tr>
    <td class="TableCell" colspan="1"><i><b>1.1. Giải thưởng trong nước</b></i></td>
...
@endphp
<tr>
    <td class="TableCell" colspan="1"><i><b>1.2. Giải thưởng quốc tế</b></i></td>
...
@endphp
<tr>
    <td class="TableCell" colspan="1"><i><b>2.1. Tập thể</b></i></td>
...
@endphp
<tr>
    <td class="TableCell" colspan="1"><i><b>2.2. Cá nhân</b></i></td>

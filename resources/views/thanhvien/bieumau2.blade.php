        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-body pad">
              <form role="form" method="POST" action="{{ url('/thanhvien/bieumau2/'.$year) }}">
                {{ csrf_field() }}
                {{ method_field('PATCH')}}
            <!-- /.box-header -->
            <!-- form start -->
                    ...
                    <div class="box-body no-padding">
                      <table class="table table-bordered">
                        ...
                        <tr>
                          ...
                          <td><input class="form-control" type="text" name="total[8]"></td>
                          <td><input class="form-control" type="text" name="total[9]"></td>
                        </tr>
                        <tr>
                ...
                <button type="submit" class="btn btn-primary">Lưu</button>
                  <a class="btn btn-default" href="{{url('thanhvien/bieumau/baocao')}}">Quay lại</a>
              </div>
              </form>
            </div>
          </div>

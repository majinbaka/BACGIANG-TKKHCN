        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-body pad">
              <form role="form" method="POST" action="{{ url('admin/thanhvien/'.$bieumau->reporter_year.'/'.$bieumau->user_id.'/bieu/1') }}">
                {{ csrf_field() }}
                {{ method_field('PATCH')}}
            ...
            <!-- form start -->
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input value="{{date('d/m/Y', strtotime($bieumau->publish_day))}}" name="publish_day"  type="text" class="form-control datemask" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="">
                ...
                <div class="form-group">
                  ...
                  <input type="text" value="{{$bieumau->reporter_transfer_name}}" name="reporter_transfer_name" class="form-control" id="reporter_transfer_name">
                </div>
                <div class="form-group">
                  <label for="reporter_eng_name">Tên tiếng Anh (nếu có):</label>
                  <input type="text" value="{{$bieumau->reporter_eng_name}}" name="reporter_eng_name" class="form-control" id="reporter_eng_name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" value="{{$bieumau->city}}" name="city" class="form-control" id="city">
                </div>
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="phone">Điện thoại:</label>
                      <input type="text"  value="{{$bieumau->phone}}" name="phone" class="form-control" id="phone">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="fax">FAX:</label>
                      <input type="text" name="fax"  value="{{$bieumau->fax}}" class="form-control" id="fax">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="email">Email:</label>
                      <input type="email"  value="{{$bieumau->email}}" name="email" class="form-control" id="email">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="website">Website:</label>
                      <input type="text" value="{{$bieumau->website}}" name="website" class="form-control" id="website">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text"  value="{{$bieumau->establish_code}}" name="establish_code" class="form-control" id="establish_code">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input value="{{date('d/m/Y', strtotime($bieumau->establish_day))}}" name="establish_day" type="text" class="form-control datemask" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="">
                    </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" value="{{$bieumau->tax_number}}" name="tax_number" class="form-control" id="tax_number">
                </div>
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input value="{{$bieumau->certificate_number}}" type="text" name="certificate_number" class="form-control" id="certificate_number">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input value="{{date('d/m/Y', strtotime($bieumau->certificate_date))}}" name="certificate_date" type="text" class="form-control datemask" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" value="{{$bieumau->certificate_grant}}" name="certificate_grant" class="form-control" id="certificate_grant">
                      </div>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <input type="text" value="{{$bieumau->manager}}" name="manager" class="form-control" id="manager">
                </div>
                <div class="form-group">
                  <label for="manager_city">Bộ/ngành,tỉnh/tp trực thuộc TƯ chủ quản :</label>
                  <input type="text" value="{{$bieumau->manager_city}}" name="manager_city" class="form-control" id="manager_city">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" value="{{$bieumau->money}}" name="money" class="form-control" id="money">
                </div>
                <div class="form-group">
                  <label for="lab_range"> Số phòng thí nghiệm chuyên ngành về KH&CN:</label>
                  <input type="text" value="{{$bieumau->lab_range}}" name="lab_range" class="form-control" id="lab_range">
                </div>
                <div class="form-group">
                  ...
                  <div class='row' id="technologytab">
                    ...
                    <div class='row tab{{$i}}'>
                      <div class='col-md-3'>
                        <input class='form-control' value="{{$tech->name}}" type='text' name='nametech{{$i}}' />
                      </div>
                      <div class='col-md-2'>
                        <input class='form-control' value="{{$tech->code}}" type='text' name='codetech{{$i}}' />
                      </div>
                      <div class='col-md-2'>
                        <input class='form-control' value="{{$tech->country}}" type='text' name='countrytech{{$i}}' />
                      </div>
                      <div class='col-md-1'>
                        <input type='text' value="{{$tech->year}}" class='form-control' name='yeartech{{$i}}' />
                      </div>
                      <div class='col-md-1'>
                        <input type='text' value="{{$tech->use_year}}" class='form-control' name='usedtech{{$i}}' />
                      </div>
                      <div class='col-md-2'>
                        <input type='text' value="{{$tech->money}}" class='form-control' name='moneytech{{$i}}' />
                      </div>
                      <div class='col-md-1'>
                        <input type='button' class='btn btn-primary' value="Xóa" onclick="$('.tab{{$i}}').remove();" />
                      </div>
                    </div>
                    @php $i++; @endphp
                    @endforeach
                ...
                <div class="form-group">
                  ...
                  <textarea name="lab_description" class="form-control">{{$bieumau->lab_description}}</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class='row element_{{$i}}' >
                    <div class='col-md-4'>
                      <input type='text' value="{{$e->name}}" class='form-control' name='nameelement{{$i}}' />
                    </div>
                    <div class='col-md-3'>
                      <input type='text' value="{{$e->leader}}" class='form-control' name='bosselement{{$i}}' />
                    </div>
                    <div class='col-md-4'>
                      <input class='form-control' value="{{$e->address}}" type='text' name='contactelement{{$i}}' />
                    </div>
                    <div class='col-md-1'>
                      <input type='button' class='btn btn-primary' value="Xóa" onclick="$('.element_{{$i}}').remove();" />
                    </div>
                  </div>
                  @php $i++; @endphp
                  @endforeach

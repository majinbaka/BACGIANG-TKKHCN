        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-body pad">
              <form role="form" method="POST" action="{{ url('/admin/tkkhth/'.$bieu->year.'/bieu/11') }}">
                {{ csrf_field() }}
                {{ method_field('PATCH')}}
            <!-- /.box-header -->
            <!-- form start -->
...
<tr>
    ...
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$bieu->field_2}}" class="form-control" type="text" name="field_2"></td>
</tr>
<tr>
    <td class="TableCell" colspan="1">1.2. Ngoài nhà nước</td>
    <td class="TableCell_Center" colspan="1">03</td>
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
    <input value="{{$bieu->field_3}}" class="form-control" type="text" name="field_3"></td>
</tr>
<tr>
    <td class="TableCell" colspan="1">1.3. Có vốn đầu tư nước ngoài</td>
    <td class="TableCell_Center" colspan="1">04</td>
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
    <input value="{{$bieu->field_4}}" class="form-control" type="text" name="field_4"></td>
</tr>
<tr>
...
<tr>
    ...
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$bieu->field_9}}" class="form-control" type="text" name="field_9"></td>
</tr>
                      </tbody></table>
                    </div>
                    <!-- /.box-body -->

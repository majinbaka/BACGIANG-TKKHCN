        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-body pad">
              <form role="form" method="POST" action="{{ url('/admin/tkkhth/'.$bieu->year.'/bieu/8') }}">
                {{ csrf_field() }}
                {{ method_field('PATCH')}}
            <!-- /.box-header -->
            <!-- form start -->
...
<tr>
    ...
    <td class="TableCell_Center" colspan="1"><i>Quy chuẩn</i></td>
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_2[1]">
    </td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_2[2]">
    </td>
</tr>
@php
...
<tr>
    ...
    <td class="TableCell_Center" colspan="1"><i>Quy chuẩn</i></td>
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_3[1]">
    </td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_3[2]">
    </td>
</tr>
@php
...
<tr>
    ...
    <td class="TableCell_Center" colspan="1"><i>Quy chuẩn</i></td>
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_6[1]">
    </td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_6[2]">
    </td>
@php
...
<tr>
    ...
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_7[1]">
    </td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_7[2]">
    </td>
</tr>
@php
...
<tr>
    ...
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_8[1]"></td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_8[2]"></td>
</tr>
<tr>
...
<tr>
    ...
    <td class="TableCell_Center" colspan="1"><i>Phương tiện</i></td>
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_10[1]"></td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_10[2]"></td>
</tr>
@php
...
<tr>
    ...
    <td class="TableCell_Center" colspan="1"><i>Phương tiện</i></td>
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_12[1]"></td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_12[2]"></td>
</tr>
@php
...
<tr>
    ...
    <td class="TableCell_Center" colspan="1"><i>Phương tiện</i></td>
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_13[1]">
    </td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_13[2]">
    </td>
</tr>
@php
...
<tr>
    ...
    <td class="TableCell_Center" colspan="1"><i>Phương tiện</i></td>
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_14[1]">
    </td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_14[2]">
    </td>
</tr>
@php
...
<tr>
    ...
    <td class="TableCell_Center" colspan="1"><i>Phương tiện</i></td>
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_15[1]"></td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_15[2]"></td>
</tr>
@php
...
<tr>
    ...
    <td class="TableCell_Center" colspan="1"><i>Phương tiện</i></td>
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_16[1]"></td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_16[2]"></td>
</tr>
@php
...
<tr>
    ...
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_17[1]">
    </td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_17[2]">
    </td>
</tr>
@php
...
<tr>
    ...
    <td class="TableCell_Center" colspan="1"><i>Giấy chứng nhận</i></td>
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_18[1]">
    </td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_18[2]">
    </td>
</tr>
@php
...
<tr>
    ...
    <td class="TableCell_Center" colspan="1"><i>Giấy chứng nhận</i></td>
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_19[1]">
    </td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_19[2]">
    </td>
</tr>
@php
...
<tr>
    ...
    <td class="TableCell_Center" rowspan="1" style="width:40px;">
      <input value="{{$out[1]}}" class="form-control" type="text" name="field_20[1]">
    </td>
    <td class="TableCell_Center" rowspan="1" style="width:50px;">
      <input value="{{$out[2]}}" class="form-control" type="text" name="field_20[2]">
    </td>
</tr>
@php

            ...
            <td align="left" valign="top">
                <div align="left">
                    <form method="POST" action="">
                        ...
                        <input type="submit" name="1" value="Biểu 01" class="Initial" id="ctl00_ContentPlaceHolder1_ctl00_Tab1" title="Biểu 01: Thông tin chung về đơn vị báo cáo" style="border-style:None;" />
                        <input type="submit" name="2" class="Clicked" value="Biểu 02" id="ctl00_ContentPlaceHolder1_ctl00_Tab2" title="Biểu 02: Nhân lực hoạt động khoa học và công nghệ" style="border-style:None;" />
...
<table style="width: 100%;">
  ...
  <tr>
    <td class="Table_Header" rowspan="2" style="width:250px;"></td>
    <td class="Table_Header" rowspan="2" style="width:50px;">Mã số</td>
    <td class="Table_Header" rowspan="2" style="width:50px;">Tổng số</td>
    <td class="Table_Header" colspan="6" rowspan="1">Chia theo trình độ chuyên môn</td>
    <td class="Table_Header" colspan="2" rowspan="1">Chức danh GS,PGS</td>
</tr>
<tr>
    <td class="Table_Header" rowspan="1">Tiến sỹ</td>
    <td class="Table_Header" rowspan="1">Thạc sỹ</td>
    <td class="Table_Header" rowspan="1">Đại học</td>
    <td class="Table_Header" rowspan="1">Cao đẳng</td>
    <td class="Table_Header" rowspan="1">Trung cấp</td>
    <td class="Table_Header" rowspan="1">Khác</td>
    <td class="Table_Header" rowspan="1">Giáo sư</td>
    <td class="Table_Header" rowspan="1">Phó Giáo sư</td>
</tr>
<tr>
...
@php
$s = parse_str($bieu->female_total, $out);
@endphp
<tr>
...
<tr>
    <td class="TableCell" colspan="1"><b>1. Chia theo dân tộc</b></td>
...
@php
$s = parse_str($bieu->nation_vn, $out);
@endphp
<tr>
    <td class="TableCell" colspan="1">1.1. Người Việt Nam</td>
...
@php
$s = parse_str($bieu->nation_kinh, $out);
@endphp
<tr>
    <td class="TableCell" colspan="1"><i> - Dân tộc Kinh</i></td>
...
@php
$s = parse_str($bieu->nation_other, $out);
@endphp
<tr>
    <td class="TableCell" colspan="1"><i> - Dân tộc thiểu số</i></td>
...
@php
$s = parse_str($bieu->nation_foregin, $out);
@endphp
<tr>
    <td class="TableCell" colspan="1">1.2. Người nước ngoài</td>
...
<tr>
    <td class="TableCell" colspan="1"><b>2. Chia theo lĩnh vực đào tạo</b></td>
    <td class="TableCell_Center" colspan="1"></td>
    <td class="TableCell_Center" colspan="1"></td>
    <td class="TableCell_Center" colspan="1"></td>
    <td class="TableCell_Center" colspan="1"></td>
...
@php
$s = parse_str($bieu->class_khtn, $out);
@endphp
<tr>
    <td class="TableCell" colspan="1">2.1. Khoa học tự nhiên</td>
...
@php
$s = parse_str($bieu->class_khkt, $out);
@endphp
<tr>
    <td class="TableCell" colspan="1">2.2. Khoa học kỹ thuật và công nghệ</td>
...
@php
$s = parse_str($bieu->class_khyd, $out);
@endphp
<tr>
    <td class="TableCell" colspan="1">2.3. Khoa học y , dược</td>
...
@php
$s = parse_str($bieu->class_khnn, $out);
@endphp
<tr>
    <td class="TableCell" colspan="1">2.4. Khoa học nông nghiệp</td>
...
@php
$s = parse_str($bieu->class_khxh, $out);
@endphp
<tr>
    <td class="TableCell" colspan="1">2.5. Khoa học xã hội</td>
...
@php
$s = parse_str($bieu->class_khnv, $out);
@endphp
<tr>
    <td class="TableCell" colspan="1">2.6. Khoa học nhân văn</td>
...
@php
$s = parse_str($bieu->class_other, $out);
@endphp
<tr>
    <td class="TableCell" colspan="1">2.7. Khác</td>
    ...
    <div style="height: 40px; text-align: center; width: 100%">
        <a href="/generate/donvi/bieu2/{{$bieu->id}}" name="ctl00$ContentPlaceHolder1$ctl00$ctl00$Button1" id="ctl00_ContentPlaceHolder1_ctl00_ctl00_Button1" class="button" >Xuất in</a>
    </div>
    </span>

...
navpanel: { height: '16px', downarrow: 'js/downsag.gif', opacity: 0.6, title: 'Go to Next Content', background: 'black' },
	loadingimg: { src: 'image/ajaxloading.gif', dimensions: [100, 2] }
}

function sagscroller(options){

    this.setting = { mode: 'manual', inittype: 'stunted', pause: 3000, animatespeed: 500, ajaxsource: null, rssdata: null, refreshsecs: 0, navpanel: { show: false, cancelauto: false}} //default settings
...
sagscroller.prototype={
	...
	addnavpanel:function(){
		...
		$navpanel.css({top:this.$slider.height()-parseInt(sagscroller_constants.navpanel.height)+10, height:sagscroller_constants.navpanel.height}).find('div').css({height:'100%'})
	},

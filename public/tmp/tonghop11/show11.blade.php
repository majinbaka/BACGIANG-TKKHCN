    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="">
            <div class="">
              <p style="float: right;text-align: right;">Biểu 11/TKTH-KHCN-ĐP<br/>26/2015/TT-BKHCN</p>
            ...
            <div class="pad">
              <center>
                <h4>DOANH NGHIỆP VÀ THỊ TRƯỜNG KHOA HỌC VÀ CÔNG NGHỆ</h4>
                <div>(Có đến ngày 31/12 năm @year@)</div>
                </center>
            <!-- form start -->
                <br>
                <br>
            ...
            <!-- form start -->
                <div class="row">
                  <div class="col-md-12">
                    <table align="right" width="100%" border="0" cellspacing="0" cellpadding="5" "mso-border-alt: none windowtext .0pt; mso-border-insideh: .0pt none windowtext; mso-border-insidev: .0pt none windowtext">
            <tr>
                <td>

                    <body lang=EN-US style='tab-interval:.5in'>
                        <div class=Section1>
                            <left><a class=MsoNormal>Ngày gửi báo cáo: ...............</a><br/> <i class=MsoNormal>(trước ngày 15 tháng 02 theo dấu bưu điện)</i>
                                <left>
                </td>
                <td>
                ...
                <td rowspan="1" align="left" colspan="17">

                    <body lang=EN-US style='tab-interval:.5in'>
                        <div class=Section1>
                            <right><b class=MsoNormal>Đơn vị báo cáo:</b><a class=MsoNormal>@reporter@
                </a><br/><b class=MsoNormal>Đơn vị nhận báo cáo:</b><a class=MsoNormal>@receiver@</a>
                                <right> <br/></td>
            </tr>
        </table>
                  </div>
...
<tr>
    ...
    @f9@
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <table align="right" width="100%" border="0" cellspacing="0" cellpadding="0" "mso-border-alt: none windowtext .0pt; mso-border-insideh: .0pt none windowtext; mso-border-insidev: .0pt none windowtext">
            <tr>
                <td>

                    <body lang=EN-US style='tab-interval:.5in'>
                        <div class=Section1>
                            <left><b  style="margin-left: 50px" class=MsoNormal>Người lập biểu</b>
                                <left>
                </td>
                <td>
                ...
                <td rowspan="1" align="right" colspan="4">

                    <body lang=EN-US style='tab-interval:.5in'>
                        <div  class=Section1>
                            <center><a class=MsoNormal> ......, ngày ...... tháng ..... năm ..... </a><br/><b class=MsoNormal>GIÁM ĐỐC</b><br/><i class=MsoNormal>(Ký, ghi rõ họ tên và đóng dấu)</i>
                                <center> <br/></td>
            </tr>
        </table>
                      </div>

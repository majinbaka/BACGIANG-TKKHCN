...
//        $bieuS->save();
    ...
    public function bieumau1UpdateFX($year)
    {
        $user = Auth::user();
        $params = Input::all();
        $rules = array(
        ...
        Session::flash('message', 'Sửa biểu thành công ');

        return Redirect::to('thanhvien/bieumau/baocao');
    }

    public function bieumau2UpdateFX($year)
    {
        $params = Input::all();
        $publish_day = DateTime::createFromFormat('d/m/Y', $params['publish_day']);
        if ($publish_day) $publish_day = $publish_day->format('Y-m-d');
    ...
    public function bieumau3UpdateFX($year)
    {
        $params = Input::all();
        $publish_day = DateTime::createFromFormat('d/m/Y', $params['publish_day']);
        if ($publish_day) $publish_day = $publish_day->format('Y-m-d');
    ...
    public function bieumau4UpdateFX($year)
    {
        $params = Input::all();
        $publish_day = DateTime::createFromFormat('d/m/Y', $params['publish_day']);
        if ($publish_day) $publish_day = $publish_day->format('Y-m-d');
    ...
    public function bieumau5UpdateFX($year)
    {
        $params = Input::all();
        $publish_day = DateTime::createFromFormat('d/m/Y', $params['publish_day']);
        if ($publish_day) $publish_day = $publish_day->format('Y-m-d');
    ...
    public function bieumau6UpdateFX($year)
    {
        $params = Input::all();
        $publish_day = DateTime::createFromFormat('d/m/Y', $params['publish_day']);
        if ($publish_day) $publish_day = $publish_day->format('Y-m-d');
